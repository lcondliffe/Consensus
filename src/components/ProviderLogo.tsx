...
function GoogleLogo({ size, className }: { size: number; className?: string }) {
  return (
    <svg
      ...
      fill="currentColor"
    >
      <path d="M12 11.807A9.002 9.002 0 0 1 10.049 2a9.942 9.942 0 0 1 1.951-.186c2.097.012 4.173.676 5.874 1.946l-1.472 2.19a6.574 6.574 0 0 0-4.402-1.503 6.381 6.381 0 0 0-5.855 3.89 6.403 6.403 0 0 0 0 4.956A6.368 6.368 0 0 0 12 17.404a5.91 5.91 0 0 0 3.957-1.4 4.665 4.665 0 0 0 1.605-2.998h-5.562v-2.636h8.714c.1.66.152 1.329.153 2a9.396 9.396 0 0 1-2.759 7.2A9.09 9.09 0 0 1 12 22a9.181 9.181 0 0 1-6.49-2.636A9.044 9.044 0 0 1 2.823 13 9.181 9.181 0 0 1 12 3.193c2.097.012 4.12.676 5.82 1.893L16.348 7.28a6.574 6.574 0 0 0-4.348-1.473A6.38 6.38 0 0 0 5.623 9.57z" />
    </svg>
  );
}
