            ...
            filteredModels.map((model) => {
              ...
              return (
                <button
                  ...
                  className={clsx(
                    'w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-left text-sm transition-all duration-200 group border',
                    isDisabled && 'opacity-40 cursor-not-allowed bg-surface-1 border-white/5',
                    !isDisabled && isSelected && 'bg-blue-500/10 border-blue-500/50 shadow-[0_0_15px_-5px_rgba(59,130,246,0.3)]',
                    !isDisabled && !isSelected && 'bg-surface-2/50 border-white/5 hover:border-white/10 hover:bg-surface-2',
